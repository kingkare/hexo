...
categories:
  - - 教程
date: '2026-02-28T02:03:42.402100+08:00'
tags:
  - hexo
  - 魔改
  - 音乐
  - 播放器
title: 魔改原项目展示位置修改为音乐播放器
updated: '2026-02-28T02:03:43.662+08:00'
---
# 修改方法
...
if home_top_config.enable
  #home_top
    .swiper_container_card(style='height: auto;width: 100%')
      ...
      #custom-music-player-placeholder(style="width: 625px; min-height: 340px; margin-left: 0.5rem;")
```

## 添加js文件

新建一个music-index.js文件并添加以下代码
...
| 名称              | 数值                                                                       |
| :---------------- | :------------------------------------------------------------------------- |
| apiBaseUrl        | 填入你的api地址，项目为[Meting API](https://github.com/injahow/meting-api) |
| defaultPlaylistId | 填入你的歌单id                                                             |
| defaultServer     | 数据源， netease 网易云音乐,tencent QQ音乐(但貌似无法正常获取了)           |
...
bottom:
  # 自定义js
  - <script src="/js/music-index.js"></script>   #首页音乐
````
